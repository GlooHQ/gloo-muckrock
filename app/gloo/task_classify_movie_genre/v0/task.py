...
from ...types import ClassifyMovieInputModel, ClassifyMovieOutputModel
from .generated import classify_movie_genre__Description, VARS

class classify_movie_genre(GlooLLMTaskInterface):
    """
    ...
    def edit_prompt_template(self) -> str:
        ...
        INPUT:
        {VARS.in_ClassifyMovieInput}

        OUTPUT FORMAT:
        {VARS.out_ClassifyMovieOutput.json}
    ...
    def edit_types_json_converter(self) -> classify_movie_genre__Description:
        return {
            "ClassifyMovieOutput": { "clues": { "name": "clues", "description": "string[]", }, "reasoning": { "name": "reasoning", "description": "string", }, "classification": { "name": "classification", "description": f"{VARS.out_ClassifyMovieOutput.classification.json}", }, "friendlyResponse": { "name": "friendlyResponse", "description": "string", }, }, "Genre": { "name": "Genre", "description": "string","case_name_formatter": lambda name: name.lower(),"case_formatter": lambda name, desc: f'{name}: {desc}',"cases": {"scifi": { "name": "scifi", "description": "A description of scifi"}, "fantasy": { "name": "fantasy", "description": "A description of fantasy"}, "mystery": { "name": "mystery", "description": "A description of mystery"}}, },
        }
    ...
    # def edit_parser(self, raw_llm_response: str) -> ClassifyMovieOutput:
    #    return super().parse(ClassifyMovieOutput, raw_llm_response)

async def run_v0(*, input: ClassifyMovieInputModel) -> ClassifyMovieOutputModel:
    task = classify_movie_genre()
...
__all__ = ["run_v0", "ClassifyMovieInputModel", "ClassifyMovieOutputModel"]
