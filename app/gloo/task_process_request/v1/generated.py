...
from ...types import ClassificationModel__Definition, ClassificationModel__OutputVars
...
class process_request__Definition(typing.TypedDict):
    ...
    Classification: ClassificationModel__Definition
...
class process_request__Vars:
    ...
    out_Classification: ClassificationModel__OutputVars = ClassificationModel__OutputVars()
