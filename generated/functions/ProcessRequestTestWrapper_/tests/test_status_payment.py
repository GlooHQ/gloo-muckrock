...
class Teststatus_payment:

    async def test_667831(self, variant: VariantTypes) -> None:
...
University of South Carolina""",
    ...
    async def test_669954(self, variant: VariantTypes) -> None:
        arg = FoiaTestCasePayload(
    name="669954",
    tid=669954,
    cid=1497695,
...
*(518) 869-3576 Ext. 0470*""",
    ...
    async def test_668306(self, variant: VariantTypes) -> None:
        arg = FoiaTestCasePayload(
    name="668306",
    tid=668306,
    cid=1492701,
...
FOIA Coordinator""",
    ...
    async def test_667875(self, variant: VariantTypes) -> None:
        arg = FoiaTestCasePayload(
    name="667875",
    tid=667875,
    cid=1491998,
...
Enclosure""",
    ...
    async def test_667592(self, variant: VariantTypes) -> None:
        arg = FoiaTestCasePayload(
    name="667592",
    tid=667592,
    cid=1491631,
...
\\B\'""",
    ...
    async def test_667637(self, variant: VariantTypes) -> None:
        arg = FoiaTestCasePayload(
    name="667637",
    tid=667637,
    cid=1491680,
...
This message and any attachments may be confidential or legally privileged and are intended only for the individual or entity identified above as the addressee.  This message is not to be forwarded, redirected, or copied to anyone except staff in Prince William County Schools or as expressly authorized by the sender.  Printed copies of this e-mail are to be held as confidential and/or legally privileged.  If you are not the addressee, or if this message has been addressed to you in error, please delete this message and any attachments and notify the sender by return e-mail or by the number(s) listed above.""",
    ...
    async def test_669226(self, variant: VariantTypes) -> None:
        arg = FoiaTestCasePayload(
    name="669226",
    tid=669226,
    cid=1496558,
...
CSP/tch""",
    ...
    async def test_668354(self, variant: VariantTypes) -> None:
        arg = FoiaTestCasePayload(
    name="668354",
    tid=668354,
    cid=1492765,
...
âSpecial Assistant to the General Counsel and Vice President of Legal Service""",
    ...
    async def test_668920(self, variant: VariantTypes) -> None:
        arg = FoiaTestCasePayload(
    name="668920",
    tid=668920,
    cid=1495504,
...
Board Adopted March 7, 2017, Updated March 13, 2018.""",
    ...
    async def test_667547(self, variant: VariantTypes) -> None:
        arg = FoiaTestCasePayload(
    name="667547",
    tid=667547,
    cid=1491580,
