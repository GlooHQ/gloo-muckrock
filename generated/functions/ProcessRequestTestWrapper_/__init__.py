...
async def ProcessRequestTestWrapper(variant: VariantTypes, args: FoiaTestCasePayload) -> FOIARequestData:

    if variant == 'v1':
        return await RunVariant_v1(args)

    raise NotImplementedError(f'Variant not found: ProcessRequestTestWrapper::{variant}')

__all__ = ["ProcessRequestTestWrapper", "VariantTypes"]
